...
#     db_session, sample_device, sample_communication_endpoint, sample_device_addressing
# ):
#     """
...
#     comm_endpoint_repository = CommunicationEndpointRepository(db_session)
#     endpoint = comm_endpoint_repository.store(sample_communication_endpoint(device.id))

#     addressing_repository = DeviceAddressingRepository(db_session)
#     addressing = addressing_repository.store(sample_device_addressing(endpoint.id))
...
# def test_index_by_endpoint_id_empty(
#     db_session, sample_device, sample_communication_endpoint
# ):
#     """
...
#     addressing_repository = DeviceAddressingRepository(db_session)
#     addressings = addressing_repository.index_by_endpoint_id(endpoint.id)
#     assert len(addressings) == 0


# def test_index_by_endpoint_id_non_empty(
#     db_session, sample_device, sample_communication_endpoint, sample_device_addressing
# ):
#     """
...
#     addressing_repository = DeviceAddressingRepository(db_session)
#     addressing1 = addressing_repository.store(sample_device_addressing(endpoint.id))
#     addressing2 = addressing_repository.store(sample_device_addressing(endpoint.id))
...
# def test_index_by_endpoint_id_nonexistent(db_session):
#     """
#     Test that index_by_endpoint_id() raises NoResultFound for non-existent endpoint.
#     """
#     addressing_repository = DeviceAddressingRepository(db_session)
#     with pytest.raises(NoResultFound):
#         addressing_repository.index_by_endpoint_id(uuid.uuid4())
...
#     addressing_repository = DeviceAddressingRepository(db_session)
#     created = addressing_repository.store(sample_device_addressing(endpoint.id))
...
#     addressing_repository = DeviceAddressingRepository(db_session)
#     data = sample_device_addressing(endpoint.id)
...
#     assert created_addressing.endpoint_id == data.endpoint_id
...
#     """
#     Test that store() raises NoResultFound when endpoint doesn't exist.
#     """
#     addressing_repository = DeviceAddressingRepository(db_session)
...
#     # Try to create duplicate with same endpoint, server, and client addresses
#     duplicate_data = sample_device_addressing(endpoint.id)
#     duplicate_data.endpoint_id = data.endpoint_id
#     duplicate_data.server_address = data.server_address
#     duplicate_data.client_address = data.client_address

#     with pytest.raises(InvalidRequestError):
#         addressing_repository.store(duplicate_data)


# def test_update_success(
#     db_session,
#     sample_device,
#     sample_communication_endpoint,
